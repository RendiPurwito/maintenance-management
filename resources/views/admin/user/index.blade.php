        ...
        <div class="card-header d-flex justify-content-between mb-2">
            ...
            <div class="btn-toolbar" role="toolbar">
                <div class="btn-group" role="group" aria-label="Third group">
                    ...
                    <a href="{{ route('user.index') }}" class="btn btn-primary btn-sm" title="View All User">
                        <i class="fa-solid fa-table-list"></i>
                    </a>
                    <a href="{{ route('user.restore_all') }}" class="btn btn-primary btn-sm" title="Restore All User">
                        <i class="fa-solid fa-arrows-spin"></i>
                    </a>
                    @else
                    <a href="{{ route('user.index', ['view_deleted' => 'DeletedRecords']) }}"
                        class="btn btn-primary btn-sm" title="View Deleted User">
