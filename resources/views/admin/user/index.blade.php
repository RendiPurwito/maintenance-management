...
@section('css')
<link rel="stylesheet" href="/template/dist/assets/vendors/simple-datatables/style.css">
...
<div class="row" id="table-hover-row">
    <div class="card">
        <div class="card-header">
            ...
            <a href="/admin/user/create" class="btn btn-primary btn-sm float-right mr-5">Create User</a>
        </div>
        <div class="card-content">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table d-table table-hover mb-0" id="table1">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="d-flex">
                                    <button class="border border-primary rounded-circle"><i class="fa-solid fa-plus"></i></button>
                                    {{ $loop->iteration }}
                                </td>
                                <td>{{ $user->name }}</td>
                                <td>{{ $user->role}}</td>
                        ...
                        <thead>
                            <tr>
                                <th data-sortable="" style="width: 7%;">
                                    <a href="#"
                                        class="dataTable-sorter">ID
                                    </a>
                                </th>
                                <th data-sortable="" style="width: 17%;">
                                    <a href="#"
                                        class="dataTable-sorter">Name
                                    </a>
                                </th>
                                <th data-sortable="" style="width: 10%;">
                                    <a href="#"
                                        class="dataTable-sorter">Role
                                    </a>
                                </th>
                                <th data-sortable="" style="width: 16%;">
                                    <a href="#"
                                        class="dataTable-sorter">Email
                                    </a>
                                </th>
                                <th data-sortable="" style="width: 13.9854%;">
                                    <a href="#"
                                        class="dataTable-sorter">Password
                                    </a>
                                </th>
                                <th data-sortable="" style="width: 14.5%;">
                                    <a href="#"
                                        class="dataTable-sorter">No Telepon
                                    </a>
                                </th>
                                <th data-sortable="" style="width: 18%;">
                                    <a href="#"
                                        class="dataTable-sorter">Alamat
                                    </a>
                                </th>
...
<script src="/template/dist/assets/vendors/simple-datatables/simple-datatables.js"></script>
